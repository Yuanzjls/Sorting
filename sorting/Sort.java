...
public final class Sort
{
    ...
    public static void Random_Intgenerator(Integer[] a)
	{
    ...
    public static long  Measure_mergeSort(Integer[] a)
	{
    	long time_start;
    ...
    public static long  Measure_quickSort(Integer[] a)
	{
    	long time_start;
    ...
    public static long  Measure_heapSort(Integer[] a)
	{
    	long time_start;
    ...
    public static long  Measure_dualpivotSort(Integer[] a)
	{
    	long time_start;
    ...
    public static void main( String [ ] args )
    {
       ...
       // Random rand = new Random(System.currentTimeMillis());
        ...
        for (int i=0; i<10; i++)
        {
        	total_time += Measure_mergeSort(a);
        	checkSort(a);
        }
        System.out.println("The mergesort time is " + total_time / 10);
        
        total_time = 0;
        for (int i=0; i<10; i++)
        {
        	total_time += Measure_quickSort(a);
        	checkSort(a);
        }
        System.out.println("The quicksort time is " + total_time / 10);
        
        total_time = 0;
        for (int i=0; i<10; i++)
        {
        	total_time += Measure_heapSort(a);
        	checkSort(a);
        }
        System.out.println("The heapsort time is " + total_time / 10);
        
        total_time = 0;
        for (int i=0; i<10; i++)
        {
        	total_time += Measure_dualpivotSort(a);
        	checkSort(a);
        }
        System.out.println("The dualpivotSort time is " + total_time / 10);
//        // Fill array a with random numbers
//        for( int i = 0; i < a.length; i++ )
//            a[i] = rand.nextInt(NUM_ITEMS * 5);
//        // Sort
